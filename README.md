...
be able to follow along if you're not familiar with dotnet Appium, but we won't
spend time introducing dotnet Appium concepts.
...
```bash
$ git clone https://github.com/percy/example-percy-appium-dotnet.git
$ cd example-percy-appium-dotnet
```
